	...
	: searchWindow(0)
{
	...
	snprintf(title, sizeof(title), _(PROJECTADJ " v%s Configuration"),
...
{
	static const QString str = _("Welcome to the qconf graphical kernel configuration tool for " PROJECT ".\n\n"
